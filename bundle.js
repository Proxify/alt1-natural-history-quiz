...
exports.scanDisplayCase = scanDisplayCase;
const OCR = __importStar(__webpack_require__(/*! alt1/ocr */ "./node_modules/alt1/dist/ocr/index.js"));
const quiz_data_1 = __webpack_require__(/*! ./quiz-data */ "./src/quiz-data.ts");
const font12 = __webpack_require__(/*! alt1/fonts/aa_12px_mono */ "./node_modules/alt1/dist/fonts/aa_12px_mono.js");
const font10 = __webpack_require__(/*! alt1/fonts/aa_10px_mono */ "./node_modules/alt1/dist/fonts/aa_10px_mono.js");
const font9allcaps = __webpack_require__(/*! alt1/fonts/aa_9px_mono_allcaps */ "./node_modules/alt1/dist/fonts/aa_9px_mono_allcaps.js");
const font8allcaps = __webpack_require__(/*! alt1/fonts/aa_8px_mono_allcaps */ "./node_modules/alt1/dist/fonts/aa_8px_mono_allcaps.js");
const font8mono = __webpack_require__(/*! alt1/fonts/aa_8px_mono */ "./node_modules/alt1/dist/fonts/aa_8px_mono.js");
const font8 = __webpack_require__(/*! alt1/fonts/aa_8px */ "./node_modules/alt1/dist/fonts/aa_8px.js");
const cbFont22 = __webpack_require__(/*! alt1/fonts/chatbox/22pt */ "./node_modules/alt1/dist/fonts/chatbox/22pt.js");
const cbFont20 = __webpack_require__(/*! alt1/fonts/chatbox/20pt */ "./node_modules/alt1/dist/fonts/chatbox/20pt.js");
const cbFont18 = __webpack_require__(/*! alt1/fonts/chatbox/18pt */ "./node_modules/alt1/dist/fonts/chatbox/18pt.js");
const cbFont16 = __webpack_require__(/*! alt1/fonts/chatbox/16pt */ "./node_modules/alt1/dist/fonts/chatbox/16pt.js");
...
function tryMatch(texts) {
    ...
    const ans = quiz_data_1.OPTIONS_MAP.get(key);
    if (ans)
        return ans;
...
function measureRow(buf, ly0, ly1, capW) {
    const W = buf.width;
    const data = buf.data;
...
function estimateWidth(text) {
    ...
    for (const ch of text) {
        if (ch === ' ') {
            w += cbFont14.spacewidth;
            continue;
        }
        const ci = (_b = (_a = cbFont14.chars.find((c) => c.chr === ch)) !== null && _a !== void 0 ? _a : cbFont14.chars.find((c) => c.chr === ch.toLowerCase())) !== null && _b !== void 0 ? _b : cbFont14.chars.find((c) => c.chr === ch.toUpperCase());
        w += ci ? ci.width : 8;
    }
    return w;
}
function matchByPixelWidth(buf, capX, capY, capW) {
    const measures = MEAS_BANDS.map(b => measureRow(buf, b.ly0, b.ly1, capW));
    // Log measurements
    console.log("[NHQ-W] Row measurements (v>220):", measures.map((m, i) => `Row${i + 1}: x=${capX + m.lxMin}-${capX + m.lxMax}(${m.lxMax - m.lxMin}px) n=${m.count}`).join("  "));
    ...
    const candidates = [];
    for (const entry of quiz_data_1.QUIZ_DATA) {
    ...
    const entry = quiz_data_1.QUIZ_DATA.find(e => e.answer === best.answer);
...
const quiz_data_1 = __webpack_require__(/*! ./quiz-data */ "./src/quiz-data.ts");
const display_case_reader_1 = __webpack_require__(/*! ./display-case-reader */ "./src/display-case-reader.ts");
const STALE_MS = 2000;
...
function highlightOption(result) {
    const normAnswer = (0, quiz_data_1.normalize)(result.answer);
    const target = result.options.find(o => (0, quiz_data_1.normalize)(o.text) === normAnswer);
    if (!target)
        return;
    alt1.overLaySetGroup(OVERLAY_GROUP);
    alt1.overLayRect(HIGHLIGHT_COLOR, target.screenX, target.screenY, target.screenW, result.lineHeight, OVERLAY_MS, 2);
    alt1.overLayText(">", HIGHLIGHT_COLOR, 14, target.screenX - 15, target.screenY + 2, OVERLAY_MS);
}
...
function tick() {
    ...
    const result = (0, display_case_reader_1.scanDisplayCase)(img);
    if (!result) {
        const now = Date.now();
...
function init() {
    ...
    if (a1lib.hasAlt1) {
        ...
        setInterval(tick, (_a = alt1.captureInterval) !== null && _a !== void 0 ? _a : TICK_MS);
    }
    else {
...
/***/ "./node_modules/alt1/dist/fonts/aa_10px_mono.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/aa_10px_mono.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_21047__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_21047__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_21047__("./src/fonts/aa_10px_mono.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/aa_12px_mono.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/aa_12px_mono.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_30652__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_30652__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_30652__("./src/fonts/aa_12px_mono.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/aa_8px.js"
/*!************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/aa_8px.js ***!
  \************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_33073__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_33073__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_33073__("./src/fonts/aa_8px.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_16950__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_16950__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_16950__("./src/fonts/aa_8px_mono.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/aa_8px_mono_allcaps.js"
/*!*************************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/aa_8px_mono_allcaps.js ***!
  \*************************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_21751__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_21751__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_21751__("./src/fonts/aa_8px_mono_allcaps.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_24910__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_24910__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_24910__("./src/fonts/aa_9px_mono_allcaps.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/10pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/10pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_32236__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_32236__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_32236__("./src/fonts/chatbox/10pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/12pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/12pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_37853__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_37853__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_37853__("./src/fonts/chatbox/12pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/14pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/14pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_45854__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_45854__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_45854__("./src/fonts/chatbox/14pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/16pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/16pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_56349__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_56349__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_56349__("./src/fonts/chatbox/16pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/18pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/18pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_73025__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_73025__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_73025__("./src/fonts/chatbox/18pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/20pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/20pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_83878__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_83878__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_83878__("./src/fonts/chatbox/20pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
...
/***/ "./node_modules/alt1/dist/fonts/chatbox/22pt.js"
/*!******************************************************!*\
  !*** ./node_modules/alt1/dist/fonts/chatbox/22pt.js ***!
  \******************************************************/
(module) {
...
/******/ 	
/******/ 	// The require function
/******/ 	function __nested_webpack_require_100192__(moduleId) {
/******/ 		// Check if module is in cache
/******/ 		var cachedModule = __webpack_module_cache__[moduleId];
/******/ 		if (cachedModule !== undefined) {
/******/ 			return cachedModule.exports;
...
/******/ 	
/******/ 		// Execute the module function
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_100192__);
/******/ 	
/******/ 		// Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
...
/******/ 	// Load entry module and return exports
/******/ 	// This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_100192__("./src/fonts/chatbox/22pt.fontmeta.json");
/******/ 	
/******/ 	return __nested_webpack_exports__;
/******/ })()
;
